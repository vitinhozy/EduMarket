...
export default defineConfig({
  ...
  server: {
    ...
    strictPort: false,
    host: true,
    // ==================== PROXY CORRIGIDO COM EXPRESSÕES REGULARES ====================
    proxy: {
      // CORRIGIDO: Simplificado para capturar qualquer rota que comece com /auth e repassar integralmente
      "/auth": {
        target: "http://localhost:3333",
        changeOrigin: true,
        ws: true,
      },
      // Simplificado para capturar qualquer rota que comece com /usuarios e repassar integralmente
      "/usuarios": {
        target: "http://localhost:3333",
        changeOrigin: true,
        ws: true,
